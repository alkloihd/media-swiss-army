...
| ☐   | Task 4: Push, PR, CI, merge → TestFlight #1                           | Local pre-PR verification complete: `test_sim` passed `163/163` and `build_sim` succeeded. Push/PR/CI/TestFlight still pending.                                                                                                                                                 |
